        ...
        <ul class="app-menu">
            ...
            <li class="menu-item">
                <a class="menu-link waves-effect" href="modulo_usuarios_list.php">
                    <span class="menu-icon"><i class="fa-solid fa-users"></i></span> <span class="menu-text">
                        Usuarios</span>
                </a>
            </li>
            ...
            <li class="menu-item">
                <a class="menu-link waves-effect" href="modulo_localidades_list.php">
                    <span class="menu-icon"><i class="fa-solid fa-location-dot"></i></span> <span class="menu-text">
                        Localidades </span>
                </a>
            </li>
            <li class="menu-item">
                    ...
                    <li class="menu-item">
                        ...
                        <div class="collapse" id="menuLayouts">
                            <ul class="sub-menu">
                                ...
                                <li class="menu-item">
                                    <a href="layout-topbar-light.html" class="menu-link">
                                        <span class="menu-text">Topbar light</span>
                                    </a>
                                </li>
                            </ul>
                        </div>
