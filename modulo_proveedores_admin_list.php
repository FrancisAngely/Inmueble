        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap  pt-3 pb-2 mb-3 border-bottom">
            ...
            &nbsp;<a href="modulo_proveedores_new.php" class="btn btn-primary">Nuevo</a>
            &nbsp;&nbsp;
        ...
        <table class="table" id="tabla">
            ...
            <tbody>
                ...
                <!-- SELECT `id`, `id_comercios`, `cif_nif_nie`, `razonsocial`, `razonsocial2`, `nombre`, `apellidos`, `direccion`, `codigopostal`, `provincia`, `localidad`, `pais`, `telefono`, `telefono2`, `fax`, `email`, `siglanacion`, `created_at`, `updated_at` FROM `proveedores` WHERE 1 -->
                <?php
                //echo "<h1>" . $_SESSION["role"] . "</h1>";
                $proveedores = getAllV("proveedores");
                //print_r($provincias); 
                ...
                ?>
                        <tr>
                            ...
                            <td><a href="modulo_proveedores_edit.php?id=<?php echo $r["id"]; ?>"><i
                                        class="fa-solid fa-pen-to-square fa-2x"></i></a>
                                &nbsp;&nbsp;
                                <a href="#" data-id="<?php echo $r["id"]; ?>" class="borrar"><i
                                        class="fa-solid fa-trash text-danger"></i>

                                    <a href="modulo_proveedores_print.php?id=<?php echo $r["id"]; ?>"><i
                ...
                <?php
                        ...
                        $excel .= '<td>' . $r["razonsocial"] . '</td>';
                        $excel .= '<td>' . $r["direccion"] . '</td>';
                        $excel .= '<td>' . $r["codigopostal"] . '</td>';
        ...
        <form action="ficheroExcel.php" method="post" enctype="multipart/form-data" id="formExportar">
            <input type="hidden" value="proveedores" name="nombreFichero">
